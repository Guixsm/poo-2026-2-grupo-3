...
O projeto foi desenvolvido com o objetivo de cumprir os requisitos propostos na atividade, envolvendo encapsulamento, construtores, herança, abstração, polimorfismo, tratamento de exceções e interface gráfica.
...
##Funcionalidades - O projeto contempla:
...
- Três subclasses: `Mago`, `Guerreiro` e `Arqueiro`.
